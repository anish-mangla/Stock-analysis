#!/usr/bin/env python3
"""
SIZING V07: Test different bull-market fractions. V04 used 1/5 in bull.
Try 1/4, 1/3, and 1/6 to find the sweet spot. All equity-based.
"""
import sys, os
...
for bull_frac, bear_frac, label in [(3, 10, "1/3 bull"), (4, 10, "1/4 bull"), (5, 10, "1/5 bull"), (6, 12, "1/6 bull")]:
    ...
    results = run_backtest(events, close, high, low, entry_filter,
        ...
        sizing_fn=make_sizing(bull_frac, bear_frac))
    print_results(results, f"SIZING V07: {label}, 1/{bear_frac} bear (equity-based)")
    save_results(results, os.path.join(os.path.dirname(__file__), f'v07_{label.replace("/","_").replace(" ","_")}_results.txt'))
